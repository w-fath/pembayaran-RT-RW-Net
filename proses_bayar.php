...
<head>
  ...
  <title>PROPOSAL RT/RW NET</title>
...
<div class="wrapper">
 ...
 ?>
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              <h2 class="box-title">Proses Pembayaran</h2>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <form method="POST" enctype="multipart/form-data">
              <div class="box-body">
              <label>Cara Transfer :</label>
                <p>1. Silahkan pilih salah satu No Rek di bawah ini dan lakukan Transfer Tunai.</p>
                <p>2. Masukan jumlah transfer sesuai pilihan harga Paket anda.</p>
                <p>3. Upload struk atau bukti pembayaran pada bagian <b>Aksi </b> <b>> Kirim Bukti</b>.</p>
                <p>4. Tunggu sampai data yang anda kirim dikonfirmasi. Estimasi waktu 1-5 Menit</p>
                <p>5. Setelah status Lunas anda dapat melakukan cetak bukti pada <b>Aksi </b> <b>> Cetak Bukti</b>.</p>
                <p>6. Jika terdapat kendala, baik dari sistem atau dari pembayaran anda bisa melakukan laporan pada bagian <b>Aksi </b> <b>> Kirim Bukti</b>.</p>
                <label>Tujuan Transfer :</label>
                <div class="form-group" style="margin-left: 35%;">
                  <label style="margin-left: 19%;">Nama Pemilik</label>
                  <br>
                  <input disabled="" type="text" class="" value="Fathor Rozi"> &ensp;&emsp;&nbsp;
                  <input disabled="" type="text" class="" value="Fathor Rozi">
                </div>

                <div class="form-group" style="margin-left: 35%;">
                  <label style="margin-left: 20%;">Jenis Bank</label>
                  <br>
                  <input disabled="" type="text" class="" value="E-Wallet">&ensp;&emsp;&nbsp;
                  <input disabled="" type="text" class="" value="BCA">
                </div>

                <div class="form-group" style="margin-left: 35%;">
                  <label style="margin-left: 22%;">No. Rek</label>
                  <br>
                  <input disabled="" type="text" class="" value="087803224618">&ensp;&emsp;&nbsp;
                  <input disabled="" type="text" class="" value="5520 8202 7890 1234">
                </div>
              </div>
            </form>
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2023 <a href="">Fathor Rozi</a>.</strong> All rights
    reserved.
  </footer>
