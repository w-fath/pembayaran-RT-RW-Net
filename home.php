        ...
        <div class="box box-primary box-solid">
            ...
            <div class="panel-body">
                ...
                <tr>
                  ...
                  <td align="center"> 
                    <a  href="proses_bayar.php" class="btn btn-info btn-sm" title=""><i class="fa fa-money"></i> Cara Bayar</a>
                    &nbsp;&nbsp;
                    <a href="support.php" class="btn btn-info btn-sm" title=""><i class="fa fa-whatsapp"></i> Butuh Bantuan</a>
                    &nbsp;&nbsp;
                    <a target="blank" href="mailto:fathorrozi14022003@gmail.com" class="btn btn-info btn-sm" title=""><i class="fa fa-upload"></i> Kirim Bukti</a>
                  </td>
                  ...
                  <td align="center"> 
                    <a  href="page/transaksi/cetak.php?id_tagihan=<?php echo $data['id_tagihan'] ;?>" class="btn btn-info btn-sm" title=""><i class="fa fa-print"></i> Cetak Bukti</a>
                    &nbsp;&nbsp;
                    <a href="support.php" class="btn btn-info btn-sm" title=""><i class="fa fa-whatsapp"></i> Butuh Bantuan</a>
                    &nbsp;&nbsp;
                    <a href="" disabled="" class="btn btn-info btn-sm" title="" ><i class="fa fa-money"></i> Cara Bayar</a>
                  </td>
...
<section class="content-header">
    ...
    <div class="pad margin no-print">
      <div class="callout callout-info" style="margin-bottom: 0!important; font-size: 25px;">
       ...
       Selamat Datang Di Aplikasi Tagihan Internet RT/RW Net
      </div>
    </div>
<?php } ?>
