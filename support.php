        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              <h2 class="box-title">Butuh Bantuan</h2>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <form method="POST" action="send.php">
              <div class="box-body">
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control" name="massage" rows="3" placeholder="Masukan Pesan"></textarea>
                </div>
                <input type="hidden" name="noWa" value="6285607696128">
